...
#define R21A_SDIO_CTRL          0x070
#define R21A_RF_B_CTRL          0x076
...
#define R21A_RXDMA_PRO          0x290
#define R21A_EARLY_MODE_CONTROL     0x2bc
...
#define R21A_TXPKT_EMPTY        0x41a
#define R21A_ARFR_5G(i)         (0x444 + (i) * 8)
#define R21A_CCK_CHECK          0x454
#define R21A_AMPDU_MAX_TIME     0x456
#define R21A_AMPDU_MAX_LENGTH       R92C_AGGLEN_LMT
#define R21A_DATA_SEC           0x483
#define R21A_ARFR_2G(i)         (0x48c + (i) * 8)
#define R21A_HT_SINGLE_AMPDU        0x4c7
...
#define R21A_CCK_RPT_FORMAT     0x804
#define R21A_OFDMCCK_EN         0x808
#define R21A_RX_PATH            R21A_OFDMCCK_EN
#define R21A_TX_PATH            0x80c
#define R21A_TXAGC_TABLE_SELECT     0x82c
#define R21A_PWED_TH            0x830
#define R21A_BW_INDICATION      0x834
#define R21A_CCA_ON_SEC         0x838
#define R21A_L1_PEAK_TH         0x848
#define R21A_FC_AREA            0x860
#define R21A_RFMOD          0x8ac
#define R21A_HSSI_PARAM2        0x8b0
#define R21A_ADC_BUF_CLK        0x8c4
#define R21A_ANTSEL_SW          0x900
#define R21A_SINGLETONE_CONT_TX     0x914
#define R21A_CCK_RX_PATH        0xa04
#define R21A_HSSI_PARAM1(chain)     (0xc00 + (chain) * 0x200)
#define R21A_TX_SCALE(chain)        (0xc1c + (chain) * 0x200)
#define R21A_TXAGC_CCK11_1(chain)   (0xc20 + (chain) * 0x200)
#define R21A_TXAGC_OFDM18_6(chain)  (0xc24 + (chain) * 0x200)
#define R21A_TXAGC_OFDM54_24(chain) (0xc28 + (chain) * 0x200)
#define R21A_TXAGC_MCS3_0(chain)    (0xc2c + (chain) * 0x200)
#define R21A_TXAGC_MCS7_4(chain)    (0xc30 + (chain) * 0x200)
#define R21A_TXAGC_MCS11_8(chain)   (0xc34 + (chain) * 0x200)
#define R21A_TXAGC_MCS15_12(chain)  (0xc38 + (chain) * 0x200)
#define R21A_TXAGC_NSS1IX3_1IX0(chain)  (0xc3c + (chain) * 0x200)
#define R21A_TXAGC_NSS1IX7_1IX4(chain)  (0xc40 + (chain) * 0x200)
#define R21A_TXAGC_NSS2IX1_1IX8(chain)  (0xc44 + (chain) * 0x200)
#define R21A_TXAGC_NSS2IX5_2IX2(chain)  (0xc48 + (chain) * 0x200)
#define R21A_TXAGC_NSS2IX9_2IX6(chain)  (0xc4c + (chain) * 0x200)
#define R21A_INITIAL_GAIN(chain)    (0xc50 + (chain) * 0x200)
#define R21A_AFE_POWER_1(chain)     (0xc60 + (chain) * 0x200)
#define R21A_AFE_POWER_2(chain)     (0xc64 + (chain) * 0x200)
#define R21A_SLEEP_NAV(chain)       (0xc80 + (chain) * 0x200)
#define R21A_PMPD(chain)        (0xc84 + (chain) * 0x200)
#define R21A_LSSI_PARAM(chain)      (0xc90 + (chain) * 0x200)
#define R21A_RFE_PINMUX(chain)      (0xcb0 + (chain) * 0x200)
#define R21A_RFE_INV(chain)     (0xcb4 + (chain) * 0x200)
#define R21A_RFE(chain)         (0xcb8 + (chain) * 0x200)
#define R21A_HSPI_READBACK(chain)   (0xd04 + (chain) * 0x40)
#define R21A_LSSI_READBACK(chain)   (0xd08 + (chain) * 0x40)
...
/* Bits for R21A_CCK_RPT_FORMAT. */
#define R21A_CCK_RPT_FORMAT_HIPWR   0x00010000

/* Bits for R21A_OFDMCCK_EN. */
#define R21A_OFDMCCK_EN_CCK 0x10000000
#define R21A_OFDMCCK_EN_OFDM    0x20000000

/* Bits for R21A_CCA_ON_SEC. */
#define R21A_CCA_ON_SEC_EXT_CHAN_M  0xf0000000
#define R21A_CCA_ON_SEC_EXT_CHAN_S  28

/* Bits for R21A_RFE_PINMUX(i). */
#define R21A_RFE_PINMUX_PA_A_MASK   0x000000f0
#define R21A_RFE_PINMUX_LNA_MASK    0x0000f000

/* Bits for R21A_RFMOD. */
#define R21A_RFMOD_EXT_CHAN_M       0x3C
#define R21A_RFMOD_EXT_CHAN_S       2

/* Bits for R21A_HSSI_PARAM2. */
#define R21A_HSSI_PARAM2_READ_ADDR_MASK 0xff

/* Bits for R21A_HSSI_PARAM1(i). */
#define R21A_HSSI_PARAM1_PI     0x00000004

/* Bits for R21A_TX_SCALE(i). */
#define R21A_TX_SCALE_SWING_M       0xffe00000
#define R21A_TX_SCALE_SWING_S       21

/* Bits for R21A_TXAGC_CCK11_1(i). */
#define R21A_TXAGC_CCK1_M       0x000000ff
#define R21A_TXAGC_CCK1_S       0
#define R21A_TXAGC_CCK2_M       0x0000ff00
#define R21A_TXAGC_CCK2_S       8
#define R21A_TXAGC_CCK55_M      0x00ff0000
#define R21A_TXAGC_CCK55_S      16
#define R21A_TXAGC_CCK11_M      0xff000000
#define R21A_TXAGC_CCK11_S      24

/* Bits for R21A_TXAGC_OFDM18_6(i). */
#define R21A_TXAGC_OFDM06_M     0x000000ff
#define R21A_TXAGC_OFDM06_S     0
#define R21A_TXAGC_OFDM09_M     0x0000ff00
#define R21A_TXAGC_OFDM09_S     8
#define R21A_TXAGC_OFDM12_M     0x00ff0000
#define R21A_TXAGC_OFDM12_S     16
#define R21A_TXAGC_OFDM18_M     0xff000000
#define R21A_TXAGC_OFDM18_S     24

/* Bits for R21A_TXAGC_OFDM54_24(i). */
#define R21A_TXAGC_OFDM24_M     0x000000ff
#define R21A_TXAGC_OFDM24_S     0
#define R21A_TXAGC_OFDM36_M     0x0000ff00
#define R21A_TXAGC_OFDM36_S     8
#define R21A_TXAGC_OFDM48_M     0x00ff0000
#define R21A_TXAGC_OFDM48_S     16
#define R21A_TXAGC_OFDM54_M     0xff000000
#define R21A_TXAGC_OFDM54_S     24

/* Bits for R21A_TXAGC_MCS3_0(i). */
#define R21A_TXAGC_MCS0_M       0x000000ff
#define R21A_TXAGC_MCS0_S       0
#define R21A_TXAGC_MCS1_M       0x0000ff00
#define R21A_TXAGC_MCS1_S       8
#define R21A_TXAGC_MCS2_M       0x00ff0000
#define R21A_TXAGC_MCS2_S       16
#define R21A_TXAGC_MCS3_M       0xff000000
#define R21A_TXAGC_MCS3_S       24

/* Bits for R21A_TXAGC_MCS7_4(i). */
#define R21A_TXAGC_MCS4_M       0x000000ff
#define R21A_TXAGC_MCS4_S       0
#define R21A_TXAGC_MCS5_M       0x0000ff00
#define R21A_TXAGC_MCS5_S       8
#define R21A_TXAGC_MCS6_M       0x00ff0000
#define R21A_TXAGC_MCS6_S       16
#define R21A_TXAGC_MCS7_M       0xff000000
#define R21A_TXAGC_MCS7_S       24

/* Bits for R21A_TXAGC_MCS11_8(i). */
#define R21A_TXAGC_MCS8_M       0x000000ff
#define R21A_TXAGC_MCS8_S       0
#define R21A_TXAGC_MCS9_M       0x0000ff00
#define R21A_TXAGC_MCS9_S       8
#define R21A_TXAGC_MCS10_M      0x00ff0000
#define R21A_TXAGC_MCS10_S      16
#define R21A_TXAGC_MCS11_M      0xff000000
#define R21A_TXAGC_MCS11_S      24

/* Bits for R21A_TXAGC_MCS15_12(i). */
#define R21A_TXAGC_MCS12_M      0x000000ff
#define R21A_TXAGC_MCS12_S      0
#define R21A_TXAGC_MCS13_M      0x0000ff00
#define R21A_TXAGC_MCS13_S      8
#define R21A_TXAGC_MCS14_M      0x00ff0000
#define R21A_TXAGC_MCS14_S      16
#define R21A_TXAGC_MCS15_M      0xff000000
#define R21A_TXAGC_MCS15_S      24
...
/* Bits for R21A_RXDMA_PRO. */
#define R21A_DMA_MODE           0x02
#define R21A_BURST_CNT_M        0x0c
#define R21A_BURST_CNT_S        2
#define R21A_BURST_SZ_M         0x30
#define R21A_BURST_SZ_S         4
#define R21A_BURST_SZ_USB3      0
#define R21A_BURST_SZ_USB2      1
#define R21A_BURST_SZ_USB1      2

/* Bits for R92C_LEDCFG2. */
#define R21A_LEDCFG2_ENA        0x20

/* Bits for R21A_DATA_SEC. */
#define R21A_DATA_SEC_NO_EXT        0x00
#define R21A_DATA_SEC_PRIM_UP_20    0x01
#define R21A_DATA_SEC_PRIM_DOWN_20  0x02
#define R21A_DATA_SEC_PRIM_UPPER_20 0x03
#define R21A_DATA_SEC_PRIM_LOWER_20 0x04
#define R21A_DATA_SEC_PRIM_UP_40    0x90
#define R21A_DATA_SEC_PRIM_DOWN_40  0xa0

/* Bits for R21A_HT_SINGLE_AMPDU. */
#define R21A_HT_SINGLE_AMPDU_PKT_ENA    0x80

/* Bits for R92C_RCR. */
#define R21A_RCR_DIS_CHK_14     0x00200000
#define R21A_RCR_TCP_OFFLD_EN       0x02000000
#define R21A_RCR_VHT_ACK        0x04000000
...
/* Bits for R21A_CCK_CHECK. */
#define R21A_CCK_CHECK_BCN1     0x20
#define R21A_CCK_CHECK_5GHZ     0x80

/*
 * CAM entries.
 */
#define R92C_CAM_ENTRY_COUNT	32
#define R21A_CAM_ENTRY_COUNT	64
...
/* Rate adaptation modes. */
#define R21A_RAID_11BGN_2_40    0
#define R21A_RAID_11BGN_1_40    1
#define R21A_RAID_11BGN_2   2
#define R21A_RAID_11BGN_1   3
#define R21A_RAID_11GN_2    4
#define R21A_RAID_11GN_1    5
#define R21A_RAID_11BG      6
#define R21A_RAID_11G       7   /* "pure" 11g */
#define R21A_RAID_11B       8
#define R21A_RAID_11AC_2_80 9
#define R21A_RAID_11AC_1_80 10
#define R21A_RAID_11AC_1    11
#define R21A_RAID_11AC_2    12
...
rtwn_chan2centieee(const struct ieee80211_channel *c)
{
    ...
    chan = (c == IEEE80211_CHAN_ANYC ?  IEEE80211_CHAN_ANY : c->ic_ieee);
    if ((c->ic_flags & IEEE80211_CHAN_HT40) == IEEE80211_CHAN_HT40U) {
        chan += 2;
    } else if ((c->ic_flags & IEEE80211_CHAN_HT40) == IEEE80211_CHAN_HT40D){
        chan -= 2;
    }
...
#define R21A_CMD_MSR_RPT        0x01
#define R21A_CMD_SET_PWRMODE        0x20
#define R21A_CMD_IQ_CALIBRATE       0x45

/* Structure for R21A_CMD_MSR_RPT. */
struct r21a_fw_cmd_msrrpt {
    uint8_t     msrb0;
#define R21A_MSRRPT_B0_DISASSOC     0x00
#define R21A_MSRRPT_B0_ASSOC        0x01
#define R21A_MSRRPT_B0_MACID_IND    0x02

    uint8_t     macid;
    uint8_t     macid_end;
} __packed;

/* Structure for R21A_CMD_SET_PWRMODE. */
struct r21a_fw_cmd_pwrmode {
    uint8_t     mode;
    uint8_t     pwrb1;
    uint8_t     bcn_pass;
    uint8_t     queue_uapsd;
    uint8_t     pwr_state;
    uint8_t     pwrb5;
#define R21A_PWRMODE_B5_NO_BTCOEX   0x40
} __packed;

struct r21a_fw_cmd_iq_calib {
    uint8_t     chan;
    uint8_t     band_bw;
 ...
 * C2H event types.
 */
#define R21A_C2H_DEBUG      0x00
#define R21A_C2H_TX_REPORT  0x03
#define R21A_C2H_BT_INFO    0x09
#define R21A_C2H_RA_REPORT  0x0c
#define R21A_C2H_IQK_FINISHED   0x11
...
#define R21A_MAX_TX_COUNT   4
#define R21A_MAX_RF_PATH    4
#define R21A_DEF_TX_PWR_2G  0x2d
#define R21A_DEF_TX_PWR_5G  0xfe
#define R21A_GROUP_2G       6
#define R21A_GROUP_5G       14


struct r21a_tx_pwr_2g {
    uint8_t     cck[R21A_GROUP_2G];
    uint8_t     ht40[R21A_GROUP_2G - 1];
} __packed;

struct r21a_tx_pwr_diff_2g {
    uint8_t     ht20_ofdm;
    struct {
        uint8_t ht40_ht20;
        uint8_t ofdm_cck;
    } __packed  diff123[R21A_MAX_TX_COUNT - 1];
} __packed;

struct r21a_tx_pwr_5g {
    uint8_t     ht40[R21A_GROUP_5G];
} __packed;

struct r21a_tx_pwr_diff_5g {
    uint8_t     ht20_ofdm;
    uint8_t     ht40_ht20[R21A_MAX_TX_COUNT - 1];
    uint8_t     ofdm_ofdm[2];
    uint8_t     ht80_ht160[R21A_MAX_TX_COUNT];
} __packed;

struct r21a_tx_pwr {
    struct r21a_tx_pwr_2g       pwr_2g;
    struct r21a_tx_pwr_diff_2g  pwr_diff_2g;
    struct r21a_tx_pwr_5g       pwr_5g;
    struct r21a_tx_pwr_diff_5g  pwr_diff_5g;
} __packed;

struct r21a_rom {
    uint8_t         reserved1[16];
    struct r21a_tx_pwr  tx_pwr[R21A_MAX_RF_PATH];
    uint8_t         channel_plan;
    uint8_t         crystalcap;
#define R21A_ROM_CRYSTALCAP_DEF     0x20
...
#define R21A_GET_ROM_PA_TYPE(lna_type, chain)       \
    (((lna_type) >> ((chain) * 4 + 2)) & 0x01)
#define R21A_GET_ROM_LNA_TYPE(lna_type, chain)  \
...
#define R21A_BOARD_TYPE_COMBO_MF    5

    uint8_t         rf_feature_opt;
    uint8_t         rf_bt_opt;
#define R21A_RF_BT_OPT_ANT_NUM      0x01
...
struct r21a_rx_phystat {
    uint8_t     gain_trsw[2];
    uint16_t    phyw1;
#define R21A_PHYW1_CHAN_M   0x03ff
#define R21A_PHYW1_CHAN_S   0
#define R21A_PHYW1_CHAN_EXT_M   0x3c00
#define R21A_PHYW1_CHAN_EXT_S   10
#define R21A_PHYW1_RFMOD_M  0xc000
#define R21A_PHYW1_RFMOD_S  14
    ...
    uint8_t     sigevm;
    uint16_t    phyw13;
#define R21A_PHYW13_ANTIDX_A_M  0x0700
#define R21A_PHYW13_ANTIDX_A_S  8
#define R21A_PHYW13_ANTIDX_B_M  0x3800
#define R21A_PHYW13_ANTIDX_B_S  11
} __packed;
...
/* Rx dword 1 */
#define R21A_RXDW1_AMSDU    0x00002000
#define R21A_RXDW1_AMPDU    0x00008000
#define R21A_RXDW1_CKSUM_ERR    0x00100000
#define R21A_RXDW1_IPV6     0x00200000
#define R21A_RXDW1_UDP      0x00400000
#define R21A_RXDW1_CKSUM    0x00800000
/* Rx dword 2 */
#define R21A_RXDW2_RPT_C2H  0x10000000
/* Rx dword 3 */
#define R21A_RXDW3_RATE_M   0x0000007f
#define R21A_RXDW3_RATE_S   0
/* Rx dword 4 */
#define R21A_RXDW4_SPLCP    0x00000001
#define R21A_RXDW4_LDPC     0x00000002
#define R21A_RXDW4_STBC     0x00000004
#define R21A_RXDW4_BW_M     0x00000030
#define R21A_RXDW4_BW_S     4
#define R21A_RXDW4_BW20     0
#define R21A_RXDW4_BW40     1
#define R21A_RXDW4_BW80     2
#define R21A_RXDW4_BW160    3
...
#define R92C_TXDW1_CIPHER_SM4   2
...
struct r21a_tx_desc_usb {
    uint16_t    pktlen;
    uint8_t     offset;
    uint8_t     flags0;
#define R21A_FLAGS0_BMCAST  0x01
#define R21A_FLAGS0_LSG     0x04
#define R21A_FLAGS0_FSG     0x08
#define R21A_FLAGS0_OWN     0x80

    uint32_t    txdw1;
#define R21A_TXDW1_MACID_M  0x0000003f
#define R21A_TXDW1_MACID_S  0
#define R21A_TXDW1_QSEL_M   0x00001f00
#define R21A_TXDW1_QSEL_S   8

#define R21A_TXDW1_QSEL_BE  0x00    /* or 0x03 */
#define R21A_TXDW1_QSEL_BK  0x01    /* or 0x02 */
#define R21A_TXDW1_QSEL_VI  0x04    /* or 0x05 */
#define R21A_TXDW1_QSEL_VO  0x06    /* or 0x07 */
#define RTWN_MAX_TID        8

#define R21A_TXDW1_QSEL_BEACON  0x10
#define R21A_TXDW1_QSEL_MGNT    0x12

#define R21A_TXDW1_RAID_M   0x001f0000
#define R21A_TXDW1_RAID_S   16
#define R21A_TXDW1_CIPHER_M 0x00c00000
#define R21A_TXDW1_CIPHER_S 22
#define R21A_TXDW1_CIPHER_NONE  0
#define R21A_TXDW1_CIPHER_RC4   1
#define R21A_TXDW1_CIPHER_SM4   2
#define R21A_TXDW1_CIPHER_AES   3
#define R21A_TXDW1_PKTOFF_M 0x1f000000
#define R21A_TXDW1_PKTOFF_S 24

    uint32_t    txdw2;
#define R21A_TXDW2_AGGEN    0x00001000
#define R21A_TXDW2_AGGBK    0x00010000
#define R21A_TXDW2_MOREFRAG 0x00020000
#define R21A_TXDW2_SPE_RPT  0x00080000
#define R21A_TXDW2_AMPDU_DEN_M  0x00700000
#define R21A_TXDW2_AMPDU_DEN_S  20

    uint32_t    txdw3;
#define R21A_TXDW3_SEQ_SEL_M    0x000000c0
#define R21A_TXDW3_SEQ_SEL_S    6
#define R21A_TXDW3_DRVRATE  0x00000100
#define R21A_TXDW3_DISRTSFB 0x00000200
#define R21A_TXDW3_DISDATAFB    0x00000400
#define R21A_TXDW3_CTS2SELF 0x00000800
#define R21A_TXDW3_RTSEN    0x00001000
#define R21A_TXDW3_HWRTSEN  0x00002000
#define R21A_TXDW3_MAX_AGG_M    0x003e0000
#define R21A_TXDW3_MAX_AGG_S    17

    uint32_t    txdw4;
#define R21A_TXDW4_DATARATE_M       0x0000007f
#define R21A_TXDW4_DATARATE_S       0
#define R21A_TXDW4_DATARATE_FB_LMT_M    0x00001f00
#define R21A_TXDW4_DATARATE_FB_LMT_S    8
#define R21A_TXDW4_RTSRATE_FB_LMT_M 0x0001e000
#define R21A_TXDW4_RTSRATE_FB_LMT_S 13
#define R21A_TXDW4_RETRY_LMT_ENA    0x00020000
#define R21A_TXDW4_RETRY_LMT_M      0x00fc0000
#define R21A_TXDW4_RETRY_LMT_S      18
#define R21A_TXDW4_RTSRATE_M        0x1f000000
#define R21A_TXDW4_RTSRATE_S        24

    uint32_t    txdw5;
#define R21A_TXDW5_DATA_PRIM_CHAN_M 0x0000000f
#define R21A_TXDW5_DATA_PRIM_CHAN_S 0
#define R21A_TXDW5_PRIM_CHAN_20_80_3    1
#define R21A_TXDW5_PRIM_CHAN_20_80_2    2
#define R21A_TXDW5_PRIM_CHAN_20_80_4    3
#define R21A_TXDW5_PRIM_CHAN_20_80_1    4
#define R21A_TXDW5_PRIM_CHAN_40_80_1    9
#define R21A_TXDW5_PRIM_CHAN_40_80_2    10
#define R21A_TXDW5_DATA_SHORT       0x00000010
#define R21A_TXDW5_DATA_BW_M        0x00000060
#define R21A_TXDW5_DATA_BW_S        5
#define R21A_TXDW5_DATA_BW40        1
#define R21A_TXDW5_DATA_BW80        2
#define R21A_TXDW5_DATA_LDPC        0x00000080
#define R21A_TXDW5_RTS_SHORT        0x00001000
#define R21A_TXDW5_RTS_PRIM_CHAN_M  0x0001e000
#define R21A_TXDW5_RTS_PRIM_CHAN_S  13
...
#define R21A_TXDW6_MBSSID_S 12
    ...
    uint16_t    txdsum;
    uint16_t    flags7;
    #define R21AU_FLAGS7_AGGNUM_M   0xff00
    #define R21AU_FLAGS7_AGGNUM_S   8

    uint32_t    txdw8;
#define R21A_TXDW8_HWSEQ_EN 0x00008000

    uint32_t    txdw9;
#define R21A_TXDW9_SEQ_M    0x00fff000
#define R21A_TXDW9_SEQ_S    12
} __packed;
